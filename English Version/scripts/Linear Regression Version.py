...
df_grid['y_pred'] = model.predict(X_poly)
...
feature_report['Absolute_Effect'] = feature_report['Coefficient'].abs()
feature_report = feature_report.sort_values(by='Absolute_Effect', ascending=False)

print(feature_report.head(10))

# 5. Model Validation Module
from sklearn.model_selection import train_test_split
from sklearn.metrics import r2_score, mean_absolute_error
print("\n" + "="*60)
print("Model Generalization Capability Validation (Train / Test Split)")
print("="*60)
...
if r2_train - r2_test > 0.15:
    print("WARNING: Potential overfitting detected (significant Train-Test performance gap).")
else:
    print("Generalization capability is satisfactory.")
...
print("=" * 60)
# 6. Build  base maps and visualizations
...
m.save("Linear Regression Version Site Selection .html")
